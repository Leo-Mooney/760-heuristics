...
property, $Al$. If $Al > 95$ then the value is $10. If $A > 97$ then the
value is $20. Now let us consider solution x with two crucibles 
$x_k, x_l$, and a neighbor y with two crucibles $y_k, y_l$. \\
$Al[x_{k,1}]=95.3,Al[x_{k,2}]=95.2,Al[x_{k,3}]=96.5,\overline{Al}[k]=95.67$\\
$Al[x_{l,1}]=96.8,Al[x_{l,2}]=96.9,Al[x_{l,3}]=95.4\overline{Al}[k]=96.37$\\

$Al[y_{k,1}]=95.3,Al[y_{k,2}]=95.2,Al[y_{k,3}]=95.4,\overline{Al}[k]=95.30$\\
$Al[y_{l,1}]=96.8,Al[y_{l,2}]=96.9,Al[y_{l,3}]=96.5\overline{Al}[k]=96.73$\\
...
found, as crucible $l$ is closer to the $97 boundary while $l$ while
$k$ is closer to the 
